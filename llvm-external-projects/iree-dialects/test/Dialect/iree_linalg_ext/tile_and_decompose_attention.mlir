...
// CHECK-SAME:         : tensor<192x1024x64xf32> to tensor<1024x64xf32>
// CHECK:            %[[EXTRACTED_SLICE_4:.+]] = tensor.extract_slice %[[ARG7]][0, 0] [1, 1024] [1, 1] :
// CHECK-SAME:         tensor<1x1024xf32> to tensor<1024xf32>
// CHECK:            %[[EXTRACTED_SLICE_5:.+]] = tensor.extract_slice %[[ARG8]][0, 0] [1, 1024] [1, 1] :
// CHECK-SAME:         tensor<1x1024xf32> to tensor<1024xf32>
...
// CHECK-SAME:         "reduction"]} ins(%[[D8]] : tensor<1024x1024xf32>) outs(%[[EXTRACTED_SLICE_4]] :
...
// CHECK-SAME:         ["parallel"]} ins(%[[EXTRACTED_SLICE_4]], %[[D9]] : tensor<1024xf32>, tensor<1024xf32>)
// CHECK-SAME:         outs(%[[EXTRACTED_SLICE_5]] : tensor<1024xf32>) {
// CHECK:            ^bb0(%[[IN:.+]]: f32, %[[IN_8:.+]]: f32, %[[OUT:.+]]: f32):
// CHECK:              %[[D17]] = arith.subf %[[IN]], %[[IN_8]] : f32
// CHECK:              %[[D18]] = math.exp %[[D17]] : f32
...
// CHECK:            ^bb0(%[[IN:.+]]: f32, %[[IN_8:.+]]: f32, %[[IN_9:.+]]: f32, %[[OUT:.+]]: f32):
// CHECK:              %[[D17]] = arith.divf %[[IN_8]], %[[IN_9]] : f32
...
// CHECK:            %[[INSERTED_SLICE_6:.+]] = tensor.insert_slice %[[D9]] into %[[ARG7]][0, 0] [1, 1024] [1, 1] :
// CHECK-SAME:         tensor<1024xf32> into tensor<1x1024xf32>
// CHECK:            %[[INSERTED_SLICE_7:.+]] = tensor.insert_slice %[[D12]] into %[[ARG8]][0, 0] [1, 1024] [1, 1] :
// CHECK-SAME:         tensor<1024xf32> into tensor<1x1024xf32>
// CHECK:            scf.yield %[[INSERTED_SLICE]], %[[INSERTED_SLICE_6]], %[[INSERTED_SLICE_7]] :
