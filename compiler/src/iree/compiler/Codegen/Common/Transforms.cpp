...
/// This pattern is adapted from the upstream
/// `BubbleUpCollapseShapeThroughExtractSlice` pattern by adding some special
/// case. Converts `tensor.extract_slice(tensor.collapse_shape)` to
